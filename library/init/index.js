...
let init = (() => {
	var _ref = _asyncToGenerator(function* () {
		...
		yield (0, _mkdirpPromise2.default)(_path2.default.dirname(readmeTarget));

		// copy init/template to $CWD
		// replace ${} expressions in the process
		yield _sander2.default.copydir(templatePath).to(cwd);

		// Create/extend existing manifest
		yield (0, _fs.writeFile)(manifestPath, JSON.stringify(data, null, '  '));
		...
		yield (0, _fs.writeFile)(readmeTarget, readmeData);
